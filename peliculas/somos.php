...
<div class="contenedor">
		...
		<p>somos una página web que mediante una pequeña base de datos<br>
		tratamos de darle al usuario  el servicio de información sobre películas.<br>
		Además de si usted quiere puede leer los comentarios y críticas de los demás<br>
		usuarios para ampliar su conocimiento e intercambiar ideas con otros usuarios<br>
		ya que le permitimos, que pueda ser participe con sus críticas y opiniones.<br>
		Si usted posee página web también podrá aprobecharse de las opciones que le brindamos<br>
		con nuestro webservice en el actualizamos continuamente nuestra base de datos<br> 
		y que usted podrá ofrecer   a los usuarios de su web.<br>
		</p>
